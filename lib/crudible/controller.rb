module Crudible
  module Controller
    ...
    # This is the scope within which records are found/built in your controller.
    # For example, `News.published`, `current_user.posts` or simply `Blog.all`
    def resource_scope
    ...
    # Should return the order by with records should be sorted. Can be a string
    # or an ActiveRecord compatible hash, e.g. ('date desc' or { date: :desc })
    #
