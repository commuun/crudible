module Crudible
  ...
  #
  class Configuration
    # The html class to apply for the new link generated by the resource_menu helper. For example, if using bootstrap, this could be 'btn btn-primary'
    attr_accessor :new_link_class

    # The html class to apply for the edit link generated by the resource_menu helper. For example, if using bootstrap, this could be 'btn btn-primary'
